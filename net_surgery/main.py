...
# Load New net
new_net = caffe.Net('/home/ls/mscnn/train_mod.prototxt', caffe.TRAIN)
...
new_alex_params_s = ['mod_conv2','mod_conv3','mod_conv4','mod_conv5', 'mod_fc6','mod_fc7','fc8']
...
new_net.save('/home/ls/py-faster-rcnn/net_surgery/mod.caffemodel')
