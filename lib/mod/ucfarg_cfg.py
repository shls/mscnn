...
__C.TRAIN.E2E_ALTER_IMS_PER_BATCH = 32
__C.TRAIN.SPATIAL_CHANNELS = 3
__C.TRAIN.MIX_CHANNELS = 4
__C.TRAIN.TEMPORAL_CHANNELS = 1
__C.TRAIN.LIST_FILE = "/home/ls/dataset/mscnn/data/random_trainval.list"  #random_trainval.list"  #full_random_trainval.txt"
...
__C.TRAIN.DATA_ROOT = '/mnt/ssd/ls/dataset/mscnn/data' #'/home/ls/dataset/mscnn/data'
__C.TRAIN.LABEL_ROOT = '/mnt/ssd/ls/dataset/mscnn/annotations' #'/home/ls/dataset/mscnn/annotations'
...
__C.TRAIN.SPATIAL_PREFEATURE_WIDTH = 128 #64
__C.TRAIN.SPATIAL_PREFEATURE_HEIGHT = 128 #64
__C.TRAIN.SPATIAL_PREFEATURE_CHANNELS = 512
__C.TRAIN.TEMPORAL_PREFEATURE_ROOT = '/mnt/ssd/ls/dataset/mscnn/temporal_data'
__C.TRAIN.TEMPORAL_PREFEATURE_WIDTH = 128 #64
__C.TRAIN.TEMPORAL_PREFEATURE_HEIGHT = 128 #64
__C.TRAIN.TEMPORAL_PREFEATURE_CHANNELS = 1
__C.TRAIN.LABEL_PREFEATURE_ROOT = '/mnt/ssd/ls/dataset/mscnn/label_reshape'
__C.TRAIN.BBOX_NUM_ORG_ROOT = '/mnt/ssd/ls/dataset/mscnn/bbox_nms_orgs'
__C.TRAIN.ORG_W = 960
__C.TRAIN.ORG_H = 540
...
__C.TEST.E2E_ALTER_IMS_PER_BATCH = 91 #359 #13
__C.TEST.END2END_IMS_PER_BATCH = 64
__C.TEST.SPATIAL_CHANNELS = 3
__C.TEST.MIX_CHANNELS = 4
__C.TEST.TEMPORAL_CHANNELS = 1
__C.TEST.LIST_FILE = "/home/ls/dataset/mscnn/data/random_test.list"  #random_test.list" #full_random_test.txt"
...
__C.TEST.DATA_ROOT = '/mnt/ssd/ls/dataset/mscnn/data' #'/home/ls/dataset/mscnn/data'
__C.TEST.LABEL_ROOT = '/mnt/ssd/ls/dataset/mscnn/annotations' #'/home/ls/dataset/mscnn/annotations'
...
__C.TEST.SPATIAL_PREFEATURE_WIDTH = 128 #64
__C.TEST.SPATIAL_PREFEATURE_HEIGHT = 128 #64
__C.TEST.SPATIAL_PREFEATURE_CHANNELS = 512
__C.TEST.TEMPORAL_PREFEATURE_ROOT = '/mnt/ssd/ls/dataset/mscnn/temporal_data'
__C.TEST.TEMPORAL_PREFEATURE_WIDTH =  128 #64
__C.TEST.TEMPORAL_PREFEATURE_HEIGHT =  128 #64
__C.TEST.TEMPORAL_PREFEATURE_CHANNELS = 1
__C.TEST.LABEL_PREFEATURE_ROOT = '/mnt/ssd/ls/dataset/mscnn/label_reshape'
__C.TEST.BBOX_NUM_ORG_ROOT = '/mnt/ssd/ls/dataset/mscnn/bbox_nms_orgs'
__C.TEST.ORG_W = 960
__C.TEST.ORG_H = 540
